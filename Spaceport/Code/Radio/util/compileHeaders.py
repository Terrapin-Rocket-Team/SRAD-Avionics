...
reg_list = ["RF_MODEM_TX_RAMP_DELAY_8", "RF_MODEM_BCR_OSR_1_9", "RF_MODEM_AFC_GEAR_7", 
            "RF_MODEM_AGC_CONTROL_1", "RF_MODEM_AGC_WINDOW_SIZE_9", "RF_MODEM_OOK_CNT1_9", "RF_MODEM_RSSI_CONTROL_1", "RF_MODEM_RSSI_COMP_1", 
