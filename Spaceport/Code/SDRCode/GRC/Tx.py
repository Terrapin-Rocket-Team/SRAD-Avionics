...
class Tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(1.0, samp_rate,samples_per_symbol, 0.35, (11*samples_per_symbol))
    ...
    def set_samples_per_symbol(self, samples_per_symbol):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(1.0, self.samp_rate, self.samples_per_symbol, 0.35, (11*self.samples_per_symbol)))
