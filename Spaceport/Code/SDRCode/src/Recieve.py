...
class Recieve(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_const_sink_x_0.set_y_axis((-.0008), .0008)
        self.qtgui_const_sink_x_0.set_x_axis((-.0008), .0008)
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq, 100e6)
