...
data_r_meas_x = data_r_meas_x[0]
data_r_meas_y = data_r_meas_y[0]
data_r_meas_z = data_r_meas_z[0]
data_a_meas_x = data_a_meas_x[0]
data_a_meas_y = data_a_meas_y[0]
data_a_meas_z = data_a_meas_z[0]
