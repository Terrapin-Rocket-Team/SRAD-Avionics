...
#include "Si4464_defs.h"
#include "SPI.h"

// include the default configuration file
#include "Si4464_default.h"
...
/*
Si4464 Hardware Configuration
- Si4464Mod mod : the modulation scheme (2FSK, 4FSK, etc)
- Si4464DataRate dataRate : the symbol rate (40k, 120k, etc)
...
*/
struct Si4464HardwareConfig
{
    Si4464Mod mod;
    Si4464DataRate dataRate;
    uint32_t channel;
    uint8_t pwr;
    uint8_t preambleLen;
...
public:
    ...
    static const uint32_t RX_TIMEOUT = 10;  // ms
    ...
    /*
    Si4464 constructor, uses the following default configuration
    Hardware:
    - mod: MOD_2GFSK
    - dataRate: DR_100k
    - freq: 433 MHz
    ...
    */
    Si4464(Si4464HardwareConfig hConfig, Si4464PinConfig pConfig);
    ...
    */
    bool tx(const uint8_t *message, uint16_t len = -1) override;
    /*
    ...
    */
    bool rx(uint8_t *data, uint16_t *len, uint16_t maxLen) override;
    /*
    ...
    */
    uint16_t writeTXBuf(const uint8_t *data, uint16_t len) override;
    /*
    ...
    Returns: the length of data successfully added
    */
    uint16_t readRXBuf(uint8_t *data, uint16_t len) override;
    ...
    */
    // void setModemConfig(Si4464Mod mod, Si4464DataRate dataRate, uint32_t freq);
    /*
    ...
    */
    void setPacketConfig(Si4464Mod mod, uint8_t preambleLength, uint8_t preambleThresh);
    /*
    ...
    */
    void setPins(Si4464Pin gpio0Mode, Si4464Pin gpio1Mode, Si4464Pin gpio2Mode, Si4464Pin gpio3Mode, Si4464Pin irqMode, bool pullup = true);
    /*
    ...
    */
    void setFRRs(Si4464FRR regAMode, Si4464FRR regBMode = FRR_NO_CHANGE, Si4464FRR regCMode = FRR_NO_CHANGE, Si4464FRR regDMode = FRR_NO_CHANGE);
    /*
    ...
    */
    void setProperty(Si4464Group group, Si4464Property start, uint8_t data);
    /*
    ...
    */
    void getProperty(Si4464Group group, Si4464Property start, uint8_t &data);
    /*
    ...
    */
    void setProperty(Si4464Group group, const uint8_t num, Si4464Property start, uint8_t *data);
    /*
    ...
    */
    void getProperty(Si4464Group group, const uint8_t num, Si4464Property start, uint8_t *data);
    /*
    ...
    */
    void waitCTS(uint32_t timeout = Si4464::CTS_TIMEOUT);
    /*
    ...
    */
    void sendCommand(Si4464Cmd cmd, uint8_t argcCmd, uint8_t *argvCmd, uint8_t argcRes, uint8_t *argvRes);
    /*
    ...
    - argvRes : the values of the response arguments
    */
    void sendCommandR(Si4464Cmd cmd, uint8_t argcRes, uint8_t *argvRes);
    /*
    ...
    - argvCmd : the values of the command arguments
    */
    void sendCommandC(Si4464Cmd cmd, uint8_t argcCmd, uint8_t *argvCmd);
    /*
