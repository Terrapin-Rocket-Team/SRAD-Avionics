...
enum Si4464Power : uint8_t
{
    POWER_MPM_30dBm = 10,
};

// pin settings
enum Si4464Pin : uint8_t
{
    PIN_DO_NOTHING = 0x00,
    PIN_TRISTATE = 0x01,
    PIN_DRIVE0 = 0x02,
