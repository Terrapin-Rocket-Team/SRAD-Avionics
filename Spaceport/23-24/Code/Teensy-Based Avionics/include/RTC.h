...
public:
    ...
    virtual char **getcsvHeader() = 0;  // these functions set to 0 are like abstract functions
    virtual char **getdataString() = 0; // don't include static values here or in csvHeader
