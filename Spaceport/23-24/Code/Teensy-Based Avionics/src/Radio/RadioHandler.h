...
namespace radioHandler
{
    void processCmdData(APRSCmdMsg &cmd, APRSCmdData &old, APRSCmdData &currentCmdData, int time)
    {
        ...
        // if(currentCmdData.Reset)
        // {
        //     recordLogData(INFO, "Reset Command Received. Restarting Flight Computer.");
        //     currentCmdData.Reset = true;
        // }
    }
